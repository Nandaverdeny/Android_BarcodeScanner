...
import com.escurity.asset.management.barcodereader.LocationBarcodeCapture;
...
public class ScanLocationActivity extends Activity implements View.OnClickListener {
    ...
    public class GetLocation extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if(LocationID != null)
            {
                Intent intent = new Intent(ScanLocationActivity.this,AssetOpnameActivity.class);
